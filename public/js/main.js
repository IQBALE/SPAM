...
(function ($) {
    ...
    $("#poli_id").change(function () {
        $.ajax({
            url: "/datapoli/" + $(this).val(),
            type: "get",
            data: {},
            success: function (data) {
                if (data.success == true) {
                    // $("#poli_area").val(data.info);
                    document.getElementById("poli_area").innerHTML =
                        '<div class="alert alert-success" ><small id="poli_area" class="form-text text-muted">' +
                        data.info +
                        "</small></div>";
                } else {
