...
<body>
    ...
    <section class="hero spad set-bg" data-setbg="img/panacea/5.jpg">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                        <div class="contact__pic">
                            <img class="custom_pic" src="img/panacea/3.jpg" alt="">
                        </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="about__text">
                        <div class="section-title">
                            <h2>Selamat Datang di Panacea</h2>
                        </div>
                        <p class="about__texts">Panacea Clinic merupakan klinik layanan kesehatan terpadu yang berdiri sejak 2006 dan diresmikan oleh Bapak Walikota Balikpapan H. Imdaad Hamid, SE.  Pada mulanya, klinik ini ditujukan untuk melayani kesehatan seluruh kalangan masyarakat Kalimantan, khususnya Balikpapan dan sekitarnya.</p> 
                        <p>Adapun layanan unggulan dari klinik ini, yaitu :</p>
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <ul>
                                    <li><i class="fa fa-check-circle"></i> Kedokteran Gigi dan Mulut</li>
                                    <li><i class="fa fa-check-circle"></i> Penyakit Dalam</li>
                                    <li><i class="fa fa-check-circle"></i> Pediatri</li>
                                    <li><i class="fa fa-check-circle"></i> Kebidanan dan Kandungan</li>
                                    <li><i class="fa fa-check-circle"></i> Bedah Umum</li>
                                    <li><i class="fa fa-check-circle"></i> Mata</li>
                                    <li><i class="fa fa-check-circle"></i> Pediatri</li>
                                </ul>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <ul>
                                    <li><i class="fa fa-check-circle"></i> THT</li>
                                    <li><i class="fa fa-check-circle"></i> Radiologi</li>
                                    <li><i class="fa fa-check-circle"></i> Kulit dan Kelamin</li>
                                    <li><i class="fa fa-check-circle"></i> Kelautan</li>
                                    <li><i class="fa fa-check-circle"></i> Rehabilitas Medis</li>
                                    <li><i class="fa fa-check-circle"></i> Kedokteran Jiwa</li>
                                </ul>
                            </div>
                        </div>
                    </div>
